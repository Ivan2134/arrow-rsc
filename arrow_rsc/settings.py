"""
Django settings for arrow_rsc project.
...
ALLOWED_HOSTS = ['10.1.173.3', '127.0.0.1', 'arrow-rsc.work', 'sbb-group.work', 'www.sbb-group.work', '176.114.12.75']
...
WSGI_APPLICATION = 'arrow_rsc.wsgi.application'
